/*
 * File: app/store/ScenarioCompetitorsStore.js
 *
...
Ext.define('DecisionLink.store.ScenarioCompetitorsStore', {
    ...
    config: {
        model: 'DecisionLink.model.ScenarioCompetitors',
        storeId: 'ScenarioCompetitorsStore',
        proxy: {
            type: 'jsonp',
            reader: {
                type: 'json',
